# Coursera + IBM: Applied Data Science Project on SpaceX Data
...
Most of the file contents are provided by default in the `Coursera: Applied Data Science Capstone` course from the `IBM: Applied Data Science Specialization`. These notebooks and Python files contain my solutions to the assignments. The goal is to acquire, analyze, and visualize SpaceX rocket launch data, build a machine learning model, and develop an interactive dashboard.
